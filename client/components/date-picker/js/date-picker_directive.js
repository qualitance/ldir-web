...
angular.module('ldrWebApp')
    ...
    .controller('customDatePickerController', ['$scope', '$timeout', '$window', function ($scope, $timeout, $window) {
        ...
        this.build = function (locale, isNewModel) {
            ...
            $scope.days = [];
            $scope.daysOfWeek = [moment.weekdaysMin(1), moment.weekdaysMin(2), moment.weekdaysMin(3),
                moment.weekdaysMin(4), moment.weekdaysMin(5), moment.weekdaysMin(6), moment.weekdaysMin(0)];
        ...
        $scope.displayYearSelection = function () {
            ...
            $timeout(function () {
                ...
                $yearSelector.scrollTop($yearSelector.scrollTop() + $activeYear.position().top -
                    $yearSelector.height() / 2 + $activeYear.height() / 2);
            });
        };
    ...
    .directive('customDatePicker', function () {
        return {
            ...
            templateUrl: 'components/date-picker/views/date-picker.html',
            link: function (scope, element, attrs, ctrl) {

                if (attrs.endDateLimit) {
                    scope.endDateLimit = scope.$eval(attrs.endDateLimit);
                }
